...
// import { useAudioPlayer } from '../../contexts/AudioPlayerContext'; // Remove this import
...
function PlayerView() {
  ...
  // const { playSong, stopSong } = useAudioPlayer(); // Remove this line
  ...
  useEffect(() => {
    if (ipcRenderer) {
      const handleUpdateMap = (event, mapData) => {
        ...
        // Remove audio playback logic from here
        // if (mapData.song_id && mapData.song_name && mapData.song_filePath) {
        //   console.log('PlayerView.js: Attempting to play song with filePath:', mapData.song_filePath);
        //   playSong({
        //     id: mapData.song_id,
        //     name: mapData.song_name,
        //     filePath: mapData.song_filePath,
        //   });
        // } else {
        //   stopSong();
        // }
  ...
  }, []); // Remove playSong and stopSong from dependency array
